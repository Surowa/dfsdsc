...
Puppet::ResourceApi.register_type(
  name: 'dsc_dfsnamespacefolder',
  dscmeta_resource_friendly_name: 'DFSNamespaceFolder',
  dscmeta_resource_name: 'MSFT_DFSNamespaceFolder',
  dscmeta_resource_implementation: 'MOF',
  dscmeta_module_name: 'DFSDsc',
  dscmeta_module_version: '4.4.0.0',
  docs: 'The DSC DFSNamespaceFolder resource type.
